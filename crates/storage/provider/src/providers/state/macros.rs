    ...
    ($target:ty $(where [$($generics:tt)*])?) => {
        $crate::providers::state::macros::delegate_impls_to_as_ref!(
            ...
            StateRootProvider $(where [$($generics)*])? {
                ...
                fn hashed_state_root_from_intermediate(&self, trie_updates: &reth_trie::updates::TrieUpdates, state: &reth_trie::HashedPostState) -> reth_storage_errors::provider::ProviderResult<reth_primitives::B256>;
            }
